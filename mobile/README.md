...
Flutter mobile client for the Church Management System. It consumes the standalone **ChMS API** (`../api` or production `https://api.paggglobal.org/api`).
...
```bash
# Start API separately (see ../api/README.md)
cd ../api && pnpm dev
